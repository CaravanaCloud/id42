...
public class BotLexStack extends Stack {
    ...
    public BotLexStack(final Construct scope, final String id, final StackProps props) {
        ...
        */
        ...
        // Alias
        var botAliasLocaleSetting = CfnBotAlias.BotAliasLocaleSettingsProperty.builder()
                .enabled(true)
                .build();
        ...
        var aliasIdOut = CfnOutput.Builder.create(this, "ID42LexBotAliasId")
                .value(this.botAlias)
                .build();


        var botIdOut = CfnOutput.Builder.create(this, "ID42LexBotId")
                .value(this.botId)
                .build();
